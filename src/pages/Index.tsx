  ...
  return (
    <Layout>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 font-space-grotesk">Featured Projects</h2>
              <p className="text-lg max-w-xl">Check out some of my best work spanning web development, IoT solutions, and data science.</p>
            </div>
      ...
      <section className="py-20 bg-pastel-yellow">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 font-space-grotesk text-center">What I Do</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="neo-card p-6">
              ...
              <h3 className="text-xl font-bold mb-3 font-space-grotesk">Web Development</h3>
              <p>Creating responsive, high-performance web applications using modern frameworks and best practices.</p>
            </div>
            ...
            <div className="neo-card p-6">
              ...
              <h3 className="text-xl font-bold mb-3 font-space-grotesk">IoT Solutions</h3>
              <p>Designing and implementing connected device ecosystems that bring the physical world online.</p>
            </div>
            ...
            <div className="neo-card p-6">
              ...
              <h3 className="text-xl font-bold mb-3 font-space-grotesk">Data Science</h3>
              <p>Extracting valuable insights from data using machine learning, statistical analysis, and visualization techniques.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-neon-pink text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 font-space-grotesk">Let's Work Together</h2>
